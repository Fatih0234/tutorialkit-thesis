...
export function InteractiveWorkspaceSurface({
  ...
  return (
    <section
      ...
      className="relative flex min-h-0 flex-1 flex-col bg-tk-elements-panel-backgroundColor"
    >
      <nav
        aria-label="Workspace panels"
        className="flex h-10 shrink-0 items-center gap-1 border-b border-tk-elements-app-borderColor bg-tk-background-primary px-3"
      >
        ...
        {terminalAvailable ? (
          <span className="ml-auto hidden text-xs text-tk-text-secondary sm:inline">
            Terminal activity is live and is not included in playback.
          </span>
        ) : null}
      </nav>
      ...
      <PanelGroup direction="horizontal" className="min-h-0 flex-1">
        ...
        >
          <aside
            ...
            className="flex h-full min-w-0 flex-col border-r border-tk-elements-app-borderColor"
          >
            <div className="panel-header shrink-0 border-b border-tk-elements-app-borderColor">
              ...
              <InteractiveButton
                variant="ghost"
                icon="i-ph-x"
                onClick={() => onExplanationOpenChange(false)}
            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-5">
              {explanationHtml ? (
                <div
                  className="markdown-content text-tk-elements-content-textColor"
        ...
        <Panel id="interactive-editor-and-terminal" defaultSize={100} minSize={40} className="min-w-0">
          <PanelGroup direction="vertical" className="min-h-0 h-full">
            ...
            <Panel
              ...
              className={
                terminalOpen && terminalAvailable ? 'min-h-0 border-t border-tk-elements-app-borderColor' : 'hidden'
              }
            >
